...
namespace noggit
{
  namespace ui
  {
      ...
      , _flatten_mode(true, true)
    {
      ...
      QRadioButton* radio_flat = new QRadioButton ("等值");
      QRadioButton* radio_linear = new QRadioButton ("线性");
      QRadioButton* radio_smooth = new QRadioButton ("渐进");
      QRadioButton* radio_origin = new QRadioButton ("原值");
      ...
      QGroupBox* flatten_blur_group = new QGroupBox("平整化", this);
      ...
      _lock_up_checkbox->setText("更高");
      _lock_up_checkbox->setToolTip("使用此微抬地面");
      _lock_down_checkbox->setChecked(_flatten_mode.lower);
      _lock_down_checkbox->setText("更低");
      _lock_down_checkbox->setToolTip("使用此微降地面");

      layout->addRow(flatten_blur_group);

      QGroupBox* flatten_only_group = new QGroupBox("平整模式", this);
      auto flatten_only_layout = new QFormLayout(flatten_only_group);

      _angle_group = new QGroupBox("可调倾斜角", this);
      ...
      _orientation_dial->setToolTip("方向角");
